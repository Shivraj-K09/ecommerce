...
export const CATEGORY_METADATA: Record<string, { title: string; subtitle: string; tagline: string; image: string }> = {
  all: {
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    image: "/products/keyboard.png", // Reuse high-quality assets to preserve styling consistency
