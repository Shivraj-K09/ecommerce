...
export default function Home() {
  ...
  // Group products by category (excluding standard filters)
        ...
        <div className="flex flex-col gap-8">
          <div className="flex justify-between items-end border-b border-zinc-200 dark:border-zinc-800/80 pb-5">
            ...
            <button 
              ...
              className="font-mono text-[9.5px] tracking-widest text-muted-foreground hover:text-foreground uppercase flex items-center gap-1.5 transition-colors cursor-pointer"
            >
