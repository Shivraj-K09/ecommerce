...
export default function ProductDetailPage({
  ...
  // Scroll reference for related products carousel
  ...
  // Load extensions from static lib constants
  ...
  return (
    <div className="relative w-full bg-background text-foreground overflow-x-hidden font-sans select-none pb-12">
      ...
      {/* Main product container - Pulled up with mt-8 to eliminate empty spaces */}
      <div className="w-full max-w-[1360px] mx-auto px-6 md:px-12 mt-8 relative z-20">
        
        {/* Back Link */}
        <div className="mb-3 select-none">
          <button
            onClick={() => startTransition(() => router.push(`/category/${product.category}`))}
        ...
        {/* ================= FIRST FOLD: ULTRA-CLEAN LUXURY MINIMAL SPLIT ================= */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-stretch">
          
          {/* LEFT COLUMN: CLASSIC PRODUCT DISPLAY */}
          ...
          {/* RIGHT COLUMN: ESSENTIAL METADATA */}
          <div className="lg:col-span-5 flex flex-col justify-between h-full py-1 text-left">
            <div className="flex flex-col gap-6">
              ...
              {/* Pristine Luxury Pricing Display */}
            ...
            <div className="flex flex-col gap-6">
              {/* Luxury Flat Buttons Layout with Shadcn Button */}
        ...
        {/* ================= SECOND FOLD: LUXURY EDITORIAL SPREAD ================= */}
        <div className="mt-20 border-t border-foreground/5 pt-14">
          ...
          {/* Clean Magazine Editorial Grid */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mt-8">
            
            {/* Story & Narrative (7 Columns) */}
            ...
            {/* Seamless Technical Specs Table (5 Columns) */}
        ...
        <div className="mt-20 border-t border-foreground/5 pt-14">
          <div className="flex items-center justify-between mb-8 select-none">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="w-10 h-10 rounded-full border border-foreground/10 hover:border-foreground/35 flex items-center justify-center text-foreground hover:bg-foreground/[0.02] active:scale-95 transition-all cursor-pointer"
                title="Scroll Left"
              >
          ...
          {/* Extremely Clean Modern Review Cards Carousel */}
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {ext.reviews[reviewTab].map((rev, idx) => {
                  ...
                  return (
                    <div
                      key={`review-${reviewTab}-${idx}`}
                      className="p-6 border border-foreground/[0.04] bg-foreground/[0.01] rounded-xl flex flex-col justify-between gap-4 transition-all duration-300 hover:border-foreground/10 w-[300px] md:w-[350px] shrink-0 snap-start"
                    >
        ...
        {relatedProducts.length > 0 && (
          <div className="mt-20 border-t border-foreground/5 pt-14">
            ...
            {/* Carousel Header with Beautiful Arrow Controls */}
            ...
            {/* Horizontal Slider - Scrollbar hidden beautifully */}
            <div
              ref={scrollRef}
              className="flex overflow-x-auto gap-6 scrollbar-none [&::-webkit-scrollbar]:hidden snap-x snap-mandatory pb-4 w-full select-none"
            >
              {relatedProducts.map((p) => (
                <div key={p.id} className="w-[260px] md:w-[280px] shrink-0 snap-start">
